    ...
    public partial class Player
    {
        private static readonly Dictionary<string, Tuple<int, int, int>> questDat =
            new Dictionary<string, Tuple<int, int, int>> //Priority, Min, Max
            {
                ...
                {"Oasis Giant", Tuple.Create(100, 1, 1000)},
                ...
                {"Lucky Ent", Tuple.Create(1100, 1, 1000)},
                {"Skull Shrine", Tuple.Create(1100, 1, 1000)},
                ...
                {"Primaeval The Ancient Totem", Tuple.Create(1010, 1, 1000)},
