...
namespace wServer.realm.setpieces
{
    ...
    {
        private static readonly string[] Ground = { "Shallow Water", "Shallow Water", "Shallow Water" };
        ...
        public void RenderSetPiece(World world, IntPoint pos)
        {
            ...
            Entity avatar = Entity.Resolve(world.Manager, "Hermit God"); //Avatar of the Forgotten King
