...
public class EquipmentToolTip extends ToolTip {
    ...
    private function addTierText():void {
        ...
        if (((((_local_1) && (_local_2))) && (_local_3))) {
            ...
            if (_local_4) {
                ...
                if (this.objectXML.hasOwnProperty("LT")) {
                    this.tierText.setColor(0xFFB732);
                    this.tierText.setStringBuilder(new LineBuilder().setParams("LT"));
                }
                else if (this.objectXML.hasOwnProperty("RT")) {
                    this.tierText.setColor(0xF9765A);
                    this.tierText.setStringBuilder(new LineBuilder().setParams("RT"));
                }
                else if (this.objectXML.hasOwnProperty("Easter")) {
                    this.tierText.setColor(0xf298f4);
                    this.tierText.setStringBuilder(new LineBuilder().setParams("Easter"));
                }
                else if (this.objectXML.hasOwnProperty("LR")) {
                    this.tierText.setColor(0xE34AF7);
                    this.tierText.setStringBuilder(new LineBuilder().setParams("LR"));
                }
                else if (this.objectXML.hasOwnProperty("@setType")) {
                    this.tierText.setColor(0xe6cc80);
                    this.tierText.setStringBuilder(new StaticStringBuilder("ST"));
                }
                else {
                    this.tierText.setColor(0x0070dd);
    ...
    private function makeRestrictionList():void {
        ...
        if (this.objectXML.hasOwnProperty("Shop")) {
            this.restrictions.push(new Restriction(("bought from the Nexus"), 0x17A589, true));
        }
        if (this.objectXML.hasOwnProperty("Ultra")) {
            this.restrictions.push(new Restriction(("Ultra items give a bigger boost than the original"), 0xffc966, false));
        }
        if (this.objectXML.hasOwnProperty("LR")) {
            this.restrictions.push(new Restriction(("Items that are far powerful than any regular item"), 0xE34AF7, false));
        }
        if (this.objectXML.hasOwnProperty("Easter")) {
            this.restrictions.push(new Restriction(("2018 Tidan Realms Easter Event"), 0xf298f4, false));
        }
