...
public class ObjectLibrary {
    ...
    public static function getRedrawnTextureFromType(_arg1:int, _arg2:int, _arg3:Boolean, _arg4:Boolean = true, _arg5:Number = 5):BitmapData {
        ...
        if (_local8 == null && _local9.hasOwnProperty("Ult"))
            return (TextureRedrawer.redraw(_local6, _arg2, _arg3, 0xFFB732, _arg4, _arg5));
        if (_local8 == null && _local9.hasOwnProperty("Easter"))
            return (TextureRedrawer.redraw(_local6, _arg2, _arg3, 0x9386e6, _arg4, _arg5));
